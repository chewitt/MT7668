...
/*
 * Step1. Decclare struct ieee80211_regdomain
 *        Define all customized regdoamin here
 */
const struct ieee80211_regdomain regdom_cus_db_ww = {
	.n_reg_rules = 1,
	.reg_rules = {
	/* channels 36..48 */
...
const struct ieee80211_regdomain regdom_cus_db_common = {
	.n_reg_rules = 2,
	.reg_rules = {
	/* channels 36..48 */
	REG_RULE_LIGHT(5180-10, 5240+10, 20, 0),
	/* channels 149..165 */
	REG_RULE_LIGHT(5745-10, 5825+10, 20, 0) }
};

const struct ieee80211_regdomain regdom_cus_db_jp = {
	.n_reg_rules = 3,
	.dfs_region = NL80211_DFS_JP,
	.reg_rules = {
	/* channels 36..48 */
	...
	/* channels 100..140 */
	REG_RULE_LIGHT(5500-10, 5700+10, 20, KAL_RRF_DFS) }
};

/*
 *  Step2. Decclare struct customized mtk_regdomain
*/

const struct mtk_regdomain my_regdom_cus_db_us = {
	.country_code = "US",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_ca = {
	.country_code = "CA",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_nz = {
	.country_code = "NZ",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_au = {
	.country_code = "AU",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_in = {
	.country_code = "IN",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_mx = {
	.country_code = "MX",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_gb = {
	.country_code = "GB",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_fr = {
	.country_code = "FR",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_it = {
	.country_code = "IT",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_de = {
	.country_code = "DE",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_es = {
	.country_code = "ES",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_ie = {
	.country_code = "IE",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_at = {
	.country_code = "AT",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_uk = {
	.country_code = "UK",
	.prRegdRules = &regdom_cus_db_common
};

const struct mtk_regdomain my_regdom_cus_db_jp = {
	.country_code = "JP",
	.prRegdRules = &regdom_cus_db_jp
};

const struct mtk_regdomain my_regdom_cus_db_ww = {
	.country_code = "WW",
	.prRegdRules = &regdom_cus_db_ww
};

const struct mtk_regdomain my_regdom_cus_db_def = {
	.country_code = "00",
	.prRegdRules = &regdom_cus_db_ww
};

/*
 * Step3. Register to customized table
 */
